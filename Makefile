...
CXXFLAGS	:= $(CFLAGS) -fno-rtti -fno-exceptions -fpermissive -Wno-parentheses -Wno-write-strings -Wno-int-to-pointer-cast -std=gnu++11 -Os -ffast-math -fomit-frame-pointer -fsingle-precision-constant -fno-asynchronous-unwind-tables
...
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(PORTLIBS) $(LIBNX) $(CURDIR)/code-mod-framework/lib/libnx_min/nx/
